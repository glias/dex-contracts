...
impl ::std::fmt::Display for Byte4 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
...
impl ::std::default::Default for Byte4 {
    fn default() -> Self {
...
impl<'r> ::std::fmt::Debug for Byte4Reader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        write!(
            f,
...
impl<'r> ::std::fmt::Display for Byte4Reader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        let raw_data = hex_string(&self.raw_data()).unwrap();
        write!(f, "{}(0x{})", Self::NAME, raw_data)
...
impl ::std::fmt::Debug for Byte4Builder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:?})", Self::NAME, &self.0[..])
    }
}
impl ::std::default::Default for Byte4Builder {
    fn default() -> Self {
        Byte4Builder([
            Byte::default(),
            Byte::default(),
